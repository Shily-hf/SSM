            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@blue.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function validate_add_form() {
        ...
        if (!regName.test(empName)) {
            ...
            show_validate_msg("#empName_add_input","error","用户名可以是2-5位中文或者6-16位英文字母和数字的组合");
            // $("#empName_add_input").parent().addClass("has-error");
            // $("#empName_add_input").next("span").text("lalalal");
            return false;
        }else {
